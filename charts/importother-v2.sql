...
UNIQUE(LocationID));
.separator ","
.import airport-tmp-ICAO.csv airports 

CREATE TABLE airportfreq(LocationID Text,Type Text, Freq Text);
.import freq-ICAO.csv airportfreq 
...
.import runway-tmp-ICAO.csv airportrunways 
...
.import airdiags/aptdiags-ICAO.csv airportdiags
